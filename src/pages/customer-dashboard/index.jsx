...
const CustomerDashboard = () => {
    ...
    if (loadingDashboard || !userData || !currentAccount) {
        return (
            <div className="flex items-center justify-center h-screen bg-[#FFFEF0]">
                <div className="text-center">
                    <div className="animate-spin h-12 w-12 border-b-2 border-black mx-auto mb-4"></div>
                    <p className="text-black font-medium">Loading your account...</p>
                </div>
            </div>
        );
    }
    ...
    return (
        <div className="pt-16 min-h-screen bg-[#FFFEF0]">
            ...
            <div className="max-w-7xl mx-auto px-4 py-8">
                ...
                <div className="mb-8 mt-6">
                    ...
                    <p className="text-gray-700 font-medium mt-2">Here's your account overview</p>
                </div>

                {/* Summary Cards */}
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                    <div className="bg-white border-2 border-black shadow-[4px_4px_0px_#000] p-6 hover:translate-x-0.5 hover:translate-y-0.5 hover:shadow-[2px_2px_0px_#000] transition-all">
                        <div className="flex items-center justify-between">
                            <div>
                                <p className="text-gray-700 font-bold text-sm mb-1">Total Sent</p>
                                <p className="text-3xl font-black text-[#FF6B6B]">
                                    ₹{typeof stats.totalSent === "number" ? stats.totalSent.toLocaleString() : "—"}
                                </p>
                                <p className="text-sm text-gray-600 mt-2">{stats.sentCount} transfers</p>
                            </div>
                            <div className="w-14 h-14 bg-[#FF6B6B]/20 border-2 border-black flex items-center justify-center">
                    ...
                    <div className="bg-white border-2 border-black shadow-[4px_4px_0px_#000] p-6 hover:translate-x-0.5 hover:translate-y-0.5 hover:shadow-[2px_2px_0px_#000] transition-all">
                        <div className="flex items-center justify-between">
                            <div>
                                <p className="text-gray-700 font-bold text-sm mb-1">Total Received</p>
                                <p className="text-3xl font-black text-[#00C9B1]">
                                    ₹{typeof stats.totalReceived === "number" ? stats.totalReceived.toLocaleString() : "—"}
                                </p>
                                <p className="text-sm text-gray-600 mt-2">{stats.receivedCount} transfers</p>
                            </div>
                            <div className="w-14 h-14 bg-[#00C9B1]/20 border-2 border-black flex items-center justify-center">
                                <svg className="w-7 h-7 text-[#00C9B1]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <div className="bg-white border-2 border-black shadow-[4px_4px_0px_#000] p-6 hover:translate-x-0.5 hover:translate-y-0.5 hover:shadow-[2px_2px_0px_#000] transition-all">
                        <div className="flex items-center justify-between">
                            <div>
                                <p className="text-gray-700 font-bold text-sm mb-1">Total Transactions</p>
                                <p className="text-3xl font-black text-[#3B82F6]">{stats.totalTransactions}</p>
                                <p className="text-sm text-gray-600 mt-2">All time</p>
                            </div>
                            <div className="w-14 h-14 bg-[#3B82F6]/20 border-2 border-black flex items-center justify-center">
                ...
                {/* Account Balance */}
                <div className="bg-white border-2 border-black shadow-[4px_4px_0px_#000] p-8 mb-8">
                    <div className="flex justify-between items-start flex-wrap gap-4">
                        <div>
                            <p className="text-gray-700 font-bold text-sm mb-2">Account Balance</p>
                            ...
                            <div className="flex gap-6 text-sm flex-wrap">
                                <div>
                                    ...
                                    <p className="font-bold text-black">{currentAccount.accountNumber}</p>
                                </div>
                                <div>
                                    <p className="text-gray-500">IFSC Code</p>
                                    <p className="font-bold text-black">{currentAccount.ifscCode}</p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div className="bg-white border-2 border-black shadow-[4px_4px_0px_#000] p-8 mb-8">
                        ...
                        <div className="space-y-4">
                            {loans.map((loan, idx) => (
                                <div
                                    key={idx}
                                    className="border-2 border-black p-6 hover:shadow-[4px_4px_0px_#000] transition-all cursor-pointer"
                                    onClick={() => handleLoanClick(loan.loanId)}
                                >
                                    <div className="flex justify-between items-start">
                                        <div className="flex-1">
                                            <div className="flex items-center gap-3 mb-3">
                                                <h4 className="text-lg font-black text-black">{loan.loanType}</h4>
                                                <span className={`px-3 py-1 text-xs font-bold border-2 border-black ${
                                                    loan.status === 'active' || loan.status === 'Active' ? 'bg-[#00C9B1]/20 text-black' :
                                                        loan.status === 'approved' || loan.status === 'Approved' ? 'bg-[#3B82F6]/20 text-black' :
                                                            loan.status === 'pending' || loan.status === 'Pending' ? 'bg-[#FFD60A] text-black' :
                                            ...
                                            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-sm">
                                                ...
                                                <div>
                                                    ...
                                                    <p className="font-bold text-black">{loan.interestRate}%</p>
                                                </div>
                                                <div>
                                            ...
                                            {(loan.status === 'active' || loan.status === 'Active') && (
                                                <div className="mt-4">
                                                    ...
                                                    <div className="w-full bg-gray-200 h-2">
                                                        <div
                                                            className="bg-[#FFD60A] h-2 transition-all duration-500"
                ...
                {/* No Loans Section */}
                {(!loans || loans.length === 0) && (
                    <div className="bg-[#FFFEF0] border-2 border-black p-6 mb-8">
                        <div className="text-center">
                            <h3 className="text-lg font-black text-black mb-2">No Loans Yet</h3>
                            <p className="text-gray-700 font-medium mb-4">Apply for a loan to see it here!</p>
                            <button
                                onClick={() => navigate('/loan-application')}
                                className="bg-[#FFD60A] text-black font-black px-6 py-2 border-2 border-black shadow-[4px_4px_0px_#000] hover:translate-x-0.5 hover:translate-y-0.5 hover:shadow-[2px_2px_0px_#000] transition-all"
                            >
                                Apply for Loan
                            </button>
                        </div>
                ...
                {/* Activity Chart */}
                <div className="bg-white border-2 border-black shadow-[4px_4px_0px_#000] p-6 mb-8">
                    <h3 className="text-xl font-black text-black mb-6">Transfer Activity (Last 7 Days)</h3>
                    <div className="space-y-3">
                        {last7DaysData.map((day, idx) => (
                            <div key={idx} className="flex items-center gap-4">
                                <div className="w-16 text-sm font-bold text-gray-600">{day.day}</div>
                                <div className="flex-1">
                                    <div className="bg-gray-200 h-8 overflow-hidden relative">
                                        <div
                                            className="bg-[#FFD60A] h-full flex items-center justify-end px-3 text-black text-sm font-bold transition-all duration-500"
                                            style={{
                ...
                <div className="bg-white border-2 border-black shadow-[4px_4px_0px_#000] p-6 mb-8">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                        <button
                            ...
                            className="flex flex-col items-center justify-center p-6 border-2 border-black hover:bg-[#FFD60A] hover:shadow-[4px_4px_0px_#000] transition-all group"
                        >
                            <div className="w-12 h-12 bg-[#FFD60A] border-2 border-black flex items-center justify-center group-hover:bg-white transition mb-3">
                                <svg className="w-6 h-6 text-black" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                                </svg>
                            </div>
                            <p className="font-black text-black">Send Money</p>
                        ...
                        >
                            ...
                            <p className="font-black text-black">View Transactions</p>
                        ...
                        >
                            ...
                            <p className="font-black text-black">Repeat Transfer</p>
                        ...
                        >
                            ...
                            <p className="font-black text-black">Apply Loan</p>
                ...
                <div className="bg-white border-2 border-black shadow-[4px_4px_0px_#000] p-6 mb-8">
                    <div className="flex justify-between items-center mb-6">
                        <h3 className="text-xl font-black text-black">Recent Transactions</h3>
                    ...
                    {!currentAccount?.transactions || currentAccount.transactions.length === 0 ? (
                        ...
                        <div className="space-y-3">
                            {currentAccount.transactions.slice(0, 10).map((txn, idx) => (
                                <div
                                    key={idx}
                                    className="flex justify-between items-center p-4 border-2 border-black hover:bg-[#FFFEF0] transition-all"
                                >
                                    <div className="flex items-center gap-4">
                                        <div className={`w-12 h-12 border-2 border-black flex items-center justify-center text-white font-black ${
                                            txn.type === 'debit' ? 'bg-[#FF6B6B]' : 'bg-[#00C9B1]'
                                        }`}>
                                            {txn.type === 'debit' ? '↑' : '↓'}
                                        </div>
                                        <div>
                                            <p className="font-black text-black">{txn.description}</p>
                                    ...
                                    <div className="text-right">
                                        <p className={`text-xl font-black ${
                                            txn.type === 'debit' ? 'text-[#FF6B6B]' : 'text-[#00C9B1]'
                                        }`}>
                                            {txn.type === 'debit' ? '-' : '+'}
                                        ...
                                        <span className={`inline-block mt-1 px-2 py-1 text-xs font-bold border border-black ${
                                            txn.status === 'completed' ? 'bg-[#00C9B1]/20 text-black' : 'bg-[#FFD60A] text-black'
                                        }`}>
